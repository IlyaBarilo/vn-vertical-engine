...
скриптов. Движок читает известные custom properties, проверяет схему, MIME,
base64, сигнатуру, размер и разрешение изображения, создаёт Blob-текстуру и
удаляет iframe. Стили пакета не подключаются к странице новеллы.
