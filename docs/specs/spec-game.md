...
`story.js` и `story360.js` дополнительно выполняются в отдельных Web Worker:
основная страница принимает от них только строку сценария и проверенную карту
360-пространств. Это не превращает произвольный JavaScript в пассивные данные.
