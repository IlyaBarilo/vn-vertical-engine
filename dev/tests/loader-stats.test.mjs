...
test('загрузчик считает сцены, действия и объявления ресурсов', async function() {
  const storyText = [
    ...
    '',
    '[bg]',
    'hall file=synthetic/bg/hall.jpg',
    'room file=synthetic/bg/room.jpg',
    '',
    '[char]',
    'anna file=synthetic/char/anna.png',
    '',
    '[audio]',
    'theme file=synthetic/audio/theme.ogg',
    '',
    '[video]',
    'clip file=synthetic/video/clip.mp4',
    '',
    '[game]',
    'puzzle file=synthetic/game/puzzle.html',
    '',
    '[scene]',
    'scene intro',
    'bg hall',
