...
function createSceneActionsStory(actions) {
  return [
    ...
    '',
    '[char]',
    'anna emotion=smile file=assets/synthetic/characters/anna.png name="Анна" color=#0F0',
    '',
    '[audio]',
    ...
    '',
    '[game]',
    'puzzle file=assets/synthetic/games/puzzle.html title="Головоломка" sandbox=strict',
    '',
    '[var]',
    'gameResult = 0',
    '',
