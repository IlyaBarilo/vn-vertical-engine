...
демо со всеми изображениями и аудио. Используйте ZIP-архив `-update`, когда
копируете новую версию движка поверх существующей новеллы; `assets/`, `story.js`
и корневой `story-example.js` в него не входят. Справочный пример в update лежит
в `docs/examples/story-example.js`.
