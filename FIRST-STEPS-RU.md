...
Справочный пример в update лежит в `docs/examples/story-example.js`.
...
Прогресс истории сохраняется в браузере автоматически, поэтому обычная
перезагрузка во время тестирования не сбрасывает текущее прохождение.
