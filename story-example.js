...
[game]
# Новые игры без sandbox=... наследуют strict из [meta].
# sandbox=legacy ниже оставлен только у встроенных старых игр, ещё не переведённых на протокол v2.
gmCoffeeRush file=assets/games/coffee-rush.html title="Удержи кофейный поток" description="Лови заказы на кофе и не нажимай на мусор. Чем выше сложность, тем быстрее поток и больше лишних объектов." cover=assets/games/coffee-rush.jpg sandbox=legacy
gmSpaceDebris file=assets/games/space-debris.html title="Космические обломки" description="Управляйте спутником с помощью кругового контроллера, чтобы пролететь через облако космических обломков." cover=assets/games/space-debris.jpg sandbox=legacy
gmScreenBenchmark file=assets/games/interactive-screen-benchmark.html title="Калибровка Системы" description="Проверьте отклик, multitouch, FPS и точность управления." cover=assets/games/interactive-screen-benchmark.jpg sandbox=legacy
gmCircuitRouting file=assets/games/snake-iso-game.html title="Маршрутизация контура" description="Проведи сигнал по плате через активные узлы. Чем выше сложность, тем быстрее поток и плотнее схема." cover=assets/games/snake-iso-game.jpg sandbox=legacy
gmMemoryProtocol file=assets/games/memory-game.html title="Лабораторный протокол: Импульс" description="Повтори последовательность световых импульсов. В нагруженном режиме сигналы идут быстрее, а серия становится длиннее." cover=assets/games/memory-game.jpg sandbox=legacy
gmComputeSpace file=assets/games/compute-space.html title="Тестирование 3D-полета" description="Тестирование 3D-полета" sandbox=legacy
gmBoardUnderVoltage file=assets/games/board-under-voltage.html title="Тестирование 3D-платы" description="Тестирование 3D-платы" sandbox=legacy
